...
var LOCALACCOUNT = config.ACCOUNT;
var LOCALUUID = config.uniqueID;
var LOCALIP=config.getIPAddress();
...
function senderFunc(ACCOUNT, IPSET, MSG, TOAPP,SENTCALLBACK) {
  var tmpmsg = encapsuMSG(MSG, LOCALACCOUNT, LOCALUUID, ACCOUNT,TOAPP);
